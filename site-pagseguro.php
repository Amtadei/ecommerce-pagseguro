...
$app->post('/payment/credit', function() {
    ...
    $shippingAddress = new Address(
        retiraAcentos($address->getdesaddress()),
        $address->getdesnumber(),
        retiraAcentos($address->getdescomplement()),
        retiraAcentos($address->getdesdistrict()),
        $address->getdeszipcode(),
        retiraAcentos($address->getdescity()),
        retiraAcentos($address->getdesstate()),
        retiraAcentos($address->getdescountry())
    );

    $birthDate = new DateTime($_POST['birth']);

    $sender = new Sender(
        retiraAcentos($order->getdesperson()),
        $cpf,
        $birthDate,
        $phone,
        $order->getdesemail(),
