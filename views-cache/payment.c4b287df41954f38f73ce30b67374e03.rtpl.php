                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane" id="tab-credito" role="tabpanel">
                                                    ...
                                                    <form action="/payment/credit" class="checkout" method="post" name="checkout" style="padding:10px;" id="form-credit">
                                                        ...
                                                        <input type="hidden" name="brad" id="brad_field">
        ...
        if (value.length >= 6) {
            ...
            PagSeguroDirectPayment.getBrand({
                ...
                success: function(response) {
                    ...
                    // Duvida o codigo abaixo não esta funcinado por isso criei a variavel acima
                    ...
                    PagSeguroDirectPayment.getInstallments({
                        ...
                        success: function(response){
                            ...
                            $.each(response.installments[bandeira], function(index, installment) {
